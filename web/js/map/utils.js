...
function get_marker_icon_name(level) {
    ...
    switch (parseInt(level, 10)) {
        case DANGER_LEVEL.ALERT:
            icon_name = './web/res/images/marker/redmarker.png';
            break;
        case DANGER_LEVEL.WARN:
            icon_name = './web/res/images/marker/yellowmarker.png';
            break;
        case DANGER_LEVEL.NORMAL:
            icon_name = './web/res/images/marker/bluemarker.png';
            break;
        default:
            icon_name = './web/res/images/marker/bluemarker.png';
            break;
    ...
    switch (parseInt(bearSpot.level, 10)) {
        case DANGER_LEVEL.ALERT:
            if (distance < ALERT_DISTANCE) {
                iconInfo = new IconInfo('./web/res/images/dot/reddot.png', 'CurrentPositionAlert');
            } else {
                iconInfo = new IconInfo('./web/res/images/dot/yellowdot.png', 'CurrentPositionWarn');
            }
            break;
        case DANGER_LEVEL.WARN:
            if (distance < ALERT_DISTANCE) {
                ...
                iconInfo = new IconInfo('./web/res/images/dot/bluedot.png', 'CurrentPositionNormal');
            }
            break;
        case DANGER_LEVEL.NORMAL:
            iconInfo = new IconInfo('./web/res/images/dot/bluedot.png', 'CurrentPositionNormal');
